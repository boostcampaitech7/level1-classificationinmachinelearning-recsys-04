...
for feature in selected_features:
    for lag in range(1, 3):  # 1-hour to 2-hour lag
...
# Forward fill을 진행한 후 남은 NaN 값을 각 열의 평균값으로 처리
train_data_filtered.fillna(train_data_filtered.mean(), inplace=True)
